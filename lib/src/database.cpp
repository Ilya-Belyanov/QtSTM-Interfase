    ...
    : QObject{parent}
{
    ...
    _step_driver_a = std::make_shared<VariableModel>("STEP DRIVER A",
                                                     VariableKeys::NEED_REAL | VariableKeys::USE_REQUEST);
    _step_driver_b = std::make_shared<VariableModel>("STEP DRIVER B",
                                                     VariableKeys::NEED_REAL | VariableKeys::USE_REQUEST);

    _step_driver_speed_a = std::make_shared<VariableModel>("STEP DRIVER SPEED A");
    _step_driver_speed_b = std::make_shared<VariableModel>("STEP DRIVER SPEED B");
}
